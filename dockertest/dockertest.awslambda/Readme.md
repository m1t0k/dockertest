...
Once you have edited your function you can use the following command lines to build, test and deploy your function to AWS Lambda from the command line (these examples assume the project name is *dockertest.awslambda*):

Restore dependencies
```
    cd "dockertest.awslambda"
    dotnet restore
```

Execute unit tests
```
    cd "dockertest.awslambda/test/dockertest.awslambda.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "dockertest.awslambda/src/dockertest.awslambda"
