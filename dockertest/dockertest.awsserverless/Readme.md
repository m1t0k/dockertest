...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *dockertest.awsserverless*):

Restore dependencies
```
    cd "dockertest.awsserverless"
    dotnet restore
```

Execute unit tests
```
    cd "dockertest.awsserverless/test/dockertest.awsserverless.Tests"
    dotnet test
```

Deploy application
```
    cd "dockertest.awsserverless/src/dockertest.awsserverless"
